...
var U2ssoMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"_id\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"_id33\",\"type\":\"uint256\"}],\"name\":\"addID\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getAllServices\",\"outputs\":[{\"internalType\":\"bytes[]\",\"name\":\"\",\"type\":\"bytes[]\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"_id\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"_id33\",\"type\":\"uint256\"}],\"name\":\"getIDIndex\",\"outputs\":[{\"internalType\":\"int256\",\"name\":\"\",\"type\":\"int256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getIDSize\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"_index\",\"type\":\"uint256\"}],\"name\":\"getIDs\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"bytes\",\"name\":\"service\",\"type\":\"bytes\"}],\"name\":\"getServiceIndex\",\"outputs\":[{\"internalType\":\"int256\",\"name\":\"\",\"type\":\"int256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"_index\",\"type\":\"uint256\"}],\"name\":\"getState\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"idList\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"id\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"id33\",\"type\":\"uint256\"},{\"internalType\":\"bool\",\"name\":\"active\",\"type\":\"bool\"},{\"internalType\":\"address\",\"name\":\"owner\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"bytes\",\"name\":\"newService\",\"type\":\"bytes\"}],\"name\":\"registerService\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"_index\",\"type\":\"uint256\"}],\"name\":\"revokeID\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"serviceCount\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"serviceList\",\"outputs\":[{\"internalType\":\"bytes\",\"name\":\"\",\"type\":\"bytes\"}],\"stateMutability\":\"view\",\"type\":\"function\"}]",
}
...
//
// Solidity: function getAllServices() view returns(bytes[])
func (_U2sso *U2ssoCaller) GetAllServices(opts *bind.CallOpts) ([][]byte, error) {
	var out []interface{}
	err := _U2sso.contract.Call(opts, &out, "getAllServices")
...
//
// Solidity: function getAllServices() view returns(bytes[])
func (_U2sso *U2ssoSession) GetAllServices() ([][]byte, error) {
	return _U2sso.Contract.GetAllServices(&_U2sso.CallOpts)
}

// GetAllServices is a free data retrieval call binding the contract method 0x21fe0f30.
//
// Solidity: function getAllServices() view returns(bytes[])
func (_U2sso *U2ssoCallerSession) GetAllServices() ([][]byte, error) {
	return _U2sso.Contract.GetAllServices(&_U2sso.CallOpts)
}
...
// GetServiceIndex is a free data retrieval call binding the contract method 0xe163691b.
//
// Solidity: function getServiceIndex(bytes service) view returns(int256)
func (_U2sso *U2ssoCaller) GetServiceIndex(opts *bind.CallOpts, service []byte) (*big.Int, error) {
	var out []interface{}
	err := _U2sso.contract.Call(opts, &out, "getServiceIndex", service)
...
//
// Solidity: function getServiceIndex(bytes service) view returns(int256)
func (_U2sso *U2ssoSession) GetServiceIndex(service []byte) (*big.Int, error) {
	return _U2sso.Contract.GetServiceIndex(&_U2sso.CallOpts, service)
}

// GetServiceIndex is a free data retrieval call binding the contract method 0xe163691b.
//
// Solidity: function getServiceIndex(bytes service) view returns(int256)
func (_U2sso *U2ssoCallerSession) GetServiceIndex(service []byte) (*big.Int, error) {
	return _U2sso.Contract.GetServiceIndex(&_U2sso.CallOpts, service)
}
...
//
// Solidity: function serviceCount() view returns(uint256)
func (_U2sso *U2ssoCaller) ServiceCount(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _U2sso.contract.Call(opts, &out, "serviceCount")
...
//
// Solidity: function serviceCount() view returns(uint256)
func (_U2sso *U2ssoSession) ServiceCount() (*big.Int, error) {
	return _U2sso.Contract.ServiceCount(&_U2sso.CallOpts)
}

// ServiceCount is a free data retrieval call binding the contract method 0x06237526.
//
// Solidity: function serviceCount() view returns(uint256)
func (_U2sso *U2ssoCallerSession) ServiceCount() (*big.Int, error) {
	return _U2sso.Contract.ServiceCount(&_U2sso.CallOpts)
}

// ServiceList is a free data retrieval call binding the contract method 0xbd293dca.
//
// Solidity: function serviceList(uint256 ) view returns(bytes)
func (_U2sso *U2ssoCaller) ServiceList(opts *bind.CallOpts, arg0 *big.Int) ([]byte, error) {
	var out []interface{}
	err := _U2sso.contract.Call(opts, &out, "serviceList", arg0)
...
//
// Solidity: function serviceList(uint256 ) view returns(bytes)
func (_U2sso *U2ssoSession) ServiceList(arg0 *big.Int) ([]byte, error) {
	return _U2sso.Contract.ServiceList(&_U2sso.CallOpts, arg0)
}

// ServiceList is a free data retrieval call binding the contract method 0xbd293dca.
//
// Solidity: function serviceList(uint256 ) view returns(bytes)
func (_U2sso *U2ssoCallerSession) ServiceList(arg0 *big.Int) ([]byte, error) {
	return _U2sso.Contract.ServiceList(&_U2sso.CallOpts, arg0)
}
...
// RegisterService is a paid mutator transaction binding the contract method 0x3f7f7995.
//
// Solidity: function registerService(bytes newService) returns()
func (_U2sso *U2ssoTransactor) RegisterService(opts *bind.TransactOpts, newService []byte) (*types.Transaction, error) {
	return _U2sso.contract.Transact(opts, "registerService", newService)
}

// RegisterService is a paid mutator transaction binding the contract method 0x3f7f7995.
//
// Solidity: function registerService(bytes newService) returns()
func (_U2sso *U2ssoSession) RegisterService(newService []byte) (*types.Transaction, error) {
	return _U2sso.Contract.RegisterService(&_U2sso.TransactOpts, newService)
}

// RegisterService is a paid mutator transaction binding the contract method 0x3f7f7995.
//
// Solidity: function registerService(bytes newService) returns()
func (_U2sso *U2ssoTransactorSession) RegisterService(newService []byte) (*types.Transaction, error) {
	return _U2sso.Contract.RegisterService(&_U2sso.TransactOpts, newService)
}
